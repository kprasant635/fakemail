...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">2021 &copy; admin</span>
    </div>
    <div>
...
<nav class="shortcut-menu d-none d-sm-block">
    ...
    <a href="{{ url('logout') }}" class="menu-item btn" data-toggle="tooltip" data-placement="left" title="Logout">
                        ...
                        <ul class="m-0">
                            ...
                            <li>
                                <a href="#" id="myapp-10" data-action="theme-update" data-themesave
                                    data-theme="{{ asset('css/themes/cust-theme-10.css') }}" data-toggle="tooltip"
                            ...
                            <li>
                                <a href="#" id="myapp-11" data-action="theme-update" data-themesave
                                    data-theme="{{ asset('css/themes/cust-theme-11.css') }}" data-toggle="tooltip"
                            ...
                            <li>
                                <a href="#" id="myapp-12" data-action="theme-update" data-themesave
                                    data-theme="{{ asset('css/themes/cust-theme-12.css') }}" data-toggle="tooltip"
                            ...
                            <li>
                                <a href="#" id="myapp-13" data-action="theme-update" data-themesave
                                    data-theme="{{ asset('css/themes/cust-theme-13.css') }}" data-toggle="tooltip"
                                    data-placement="top" title="Emerald" data-original-title="Emerald"></a>
                            </li>
                            <li>
                                <a href="#" id="myapp-14" data-action="theme-update" data-themesave
                                    data-theme="{{ asset('css/themes/cust-theme-14.css') }}" data-toggle="tooltip"
                            ...
                            <li>
                                <a href="#" id="myapp-15" data-action="theme-update" data-themesave
                                    data-theme="{{ asset('css/themes/cust-theme-15.css') }}" data-toggle="tooltip"
                        ...
                        <div class="row no-gutters">
                                ...
                                <div id="skin-default" data-action="toggle-replace"
                                    ...
                                    <div class="d-flex flex-column flex-1">
                                        ...
                                        <div class="bg-faded flex-1 pt-3 pb-3 px-2">
                                            <div class="py-3"
                                                style="background:url('{{ asset('/img/demo/s-1.png') }}') top left no-repeat;background-size: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-4 px-1 text-center">
                                <div id="skin-light" data-action="toggle-replace" data-replaceclass="mod-skin-dark"
                                    data-class="mod-skin-light" data-toggle="tooltip" data-placement="top"
                                    title=""
                            ...
                            <div class="col-4 pl-2 text-center">
                                <div id="skin-dark" data-action="toggle-replace" data-replaceclass="mod-skin-light"
                                    data-class="mod-skin-dark" data-toggle="tooltip" data-placement="top"
                                    title=""
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-6 pl-1">
                                <a href="#" class="btn btn-danger fw-500 btn-block"
                                    data-action="factory-reset">Factory
                                    Reset</a>
                            </div>
                        </div>
                    </div>
...
{{-- modal for cghs chart --}}

{{-- End modal for cghs chart --}}
...
<script src="{{ asset('js/encrypt/encrypt.js') }}"></script> --}}
...
<script>
    $(document).ready(function() {
        $('#dt-basic-example-user').dataTable({
            responsive: true
        });

    });
</script>
<!-- end manage user scriptW -->
...
<script src="{{ asset('js/delalert.js') }}"></script>
<script src="{{ asset('js/CommnJs.js') }}"></script>
...
<script type="text/javascript">
    ...
    $('#datatable5').dataTable({
        ...
        dom: "<'row mb-3'<'col-sm-12 col-md-6 d-flex align-items-center justify-content-start'f><'col-sm-12 col-md-6 d-flex align-items-center justify-content-end'B>>" +
            "<'row'<'col-sm-12'tr>>" +
            "<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>'<'botm'l>'tip",
        pageLength: 3,
        lengthMenu: [
            [3, 6, 9, 12],
            [3, 6, 9, 12]
